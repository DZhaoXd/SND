...
_C.DTU.DYNAMIC = True
_C.DTU.Query_STEP = 3
_C.DTU.Query_START = 9
_C.DTU.META_MAX_UPDATE = 30
_C.DTU.EMA_WEIGHT = 0.99
_C.DTU.PROXY_METRIC = 'ENT'
_C.DTU.FIX_ITERATION = 12
_C.DTU.MAX_ITERATION = 6000

# List of the DTU configs
_C.TCR = CN()
_C.TCR.SAMPLE_LIST = [1,2,3]
_C.TCR.TOPK_CANDIDATE = 0.5
_C.TCR.UPDATE_FREQUENCY = 3000
_C.TCR.OPEN = True

# List of the METAPL configs
_C.METAPL = CN()
_C.METAPL.OPEN = True
_C.METAPL.VAL_UPDATE = 1000
_C.METAPL.TOP_K = 0.01
